...
from DF_transformer import DFFConfig
from DF_transformer import DFFForImageClassification
...
class DataTrainingArguments:
    ...
    train_data: Optional[str] = field(
        default='/home/chendo11/workfolder/DFFransformer/DFFeatures_Data/PL_v2016_refine_train_ele_scheme_1-norm_ph_vr-10.npy',
        metadata={"help": "A folder containing the training data, .npy file."}
    )
    train_label: Optional[str] = field(
        default='/home/chendo11/workfolder/DFFransformer/DFFeatures_Data/v2016_refine_train_label.csv',
        metadata={"help": "A folder containing the training data, .csv file."}
    )
    validation_data: Optional[str] = field(default='/home/chendo11/workfolder/DFFransformer/DFFeatures_Data/PL_v2016_core_test_ele_scheme_1-norm_ph_vr-10.npy', metadata={"help": "A folder containing the validation data."})
    validation_label: Optional[str] = field(default='/home/chendo11/workfolder/DFFransformer/DFFeatures_Data/v2016_core_test_label.csv', metadata={"help": "A folder containing the validation data."})
...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default='/home/chendo11/workfolder/DFFransformer/Output_dir/pretrain_from_vit_gpu',
        metadata={
            "help": (
...
class CustomTrainingArguments(TrainingArguments):
    ...
    output_dir: Optional[str] = field(
        default='/home/chendo11/workfolder/DFFransformer/Output_dir/finetuning_for_v2016',
...
def DFF_Finetuning():
    ...
    if model_args.model_name_or_path:
        config = DFFConfig.from_pretrained(model_args.model_name_or_path)
        config.update(dict(
        ...
        model = DFFForImageClassification.from_pretrained(model_args.model_name_or_path, config=config)
...
def main():
    """
        Normal example:
        CUDA_VISIBLE_DEVICES=2 python /home/chendo11/workfolder/DFFransformer/code_pkg/DFF_regression_finetuning.py --hidden_dropout_prob 0.5 --attention_probs_dropout_prob 0.1 --num_train_epochs 50 --per_device_train_batch_size 64 --output_dir /home/chendo11/workfolder/DFFransformer/Output_dir/finetune_for_regression_2 --model_name_or_path /home/chendo11/workfolder/DFFransformer/Output_dir/pretrain_allpdb_mask30_3channels/checkpoint-11590 --scaler_path /home/chendo11/workfolder/DFFransformer/code_pkg/pretrain_data_standard_minmax_3channel.sav --validation_data /home/chendo11/workfolder/DFFransformer/TopFeatures_Data/top_v2016_core_test_ele_scheme_1-combined_3channel-10.npy --train_data /home/chendo11/workfolder/DFFransformer/TopFeatures_Data/top_v2016_refine_train_ele_scheme_1-combined_3channel-10.npy
        ...
        Example:
        >>> CUDA_VISIBLE_DEVICES=1,2 python -m torch.distributed.launch --nproc_per_node 2 /home/chendo11/workfolder/DFFransformer/code_pkg/utils/DFF_masked_pretrain.py

        # or select the specific GPUs and control their order
        >>> CUDA_VISIBLE_DEVICES=1,2 python -m torch.distributed.launch /home/chendo11/workfolder/DFFransformer/code_pkg/utils/DFF_masked_pretrain.py

        New version based on: https://pytorch.org/docs/stable/elastic/run.html
        >>> torchrun --nnodes=2 --nproc_per_node=2 /home/chendo11/workfolder/DFFransformer/code_pkg/utils/DFF_masked_pretrain.py
    """
    DFF_Finetuning()
